...
const HERO_PHRASES = [
  ...
  "Practice Daily Communication with AI",
      ...
      <div className="grid w-full items-center gap-8 lg:grid-cols-[1fr_1fr]">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-3 max-w-xl text-base leading-7 text-slate-600 dark:text-slate-300">
            Prepare for interviews, improve your English, practice
            daily communication with AI, and practice with your own
            questions through realistic conversations and instant
            feedback.
          </p>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <p className="flex items-center gap-1 text-sm font-medium text-primary">
              <Sparkles size={14} />
              <TypingAnimation phrases={HERO_PHRASES} />
            </p>
          </div>
